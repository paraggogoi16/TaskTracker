...
<header class="main-header">
	...
	<a href="${pageContext.request.contextPath}/dashboard" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		<span class="logo-mini"><b>TASK</b></span> <!-- logo for regular state and mobile devices -->
				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu">
						...
						<li class="user-footer">
							<div class="pull-left">
								<!-- <a href="http://localhost:8080/ALPO/jsp/home.jsp" class="btn btn-default btn-flat">Back to LPO</a> -->
							</div> 
							 <div class="pull-right">
								<a href="/grivience/logout" class="btn btn-default btn-flat">Sign out</a>
							</div>
						</li>
					</ul>
				</li>
